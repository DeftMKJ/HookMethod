...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [NSArray avoidCrash_Open];
    [UIViewController hook_ViewcontrollerOpen];
...
//    [UIView mkjHook_GestureOpen]; 手势View的点击会触发太多东西，有待研究
    ...
    UINavigationController *nvc = [[UINavigationController alloc] initWithRootViewController:[[FirstViewController alloc] init]];
